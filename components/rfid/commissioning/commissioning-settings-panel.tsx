  ...
  return (
    <div className="rounded-lg border border-slate-800 bg-zinc-950/80">
      <button
        type="button"
        onClick={onToggle}
        className="flex w-full items-center justify-between gap-2 px-4 py-3 text-left font-mono text-xs font-medium uppercase tracking-wider text-slate-400 hover:bg-zinc-900/60"
      >
      ...
      {open ? (
        <div className="space-y-4 border-t border-slate-800 px-4 py-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="block font-mono text-[0.65rem] uppercase text-slate-500">
              ...
              <input
                ...
                className="mt-1 w-full rounded border border-slate-800 bg-zinc-900/50 px-2 py-2 font-mono text-sm text-slate-400"
              />
            </label>
            <div className="flex gap-2">
              <label className="block flex-1 font-mono text-[0.65rem] uppercase text-slate-500">
                Bits — item
                <input
                  type="number"
                  readOnly
          ...
          <label className="block font-mono text-[0.65rem] uppercase text-slate-500">
            Printer <span className="text-slate-600">(host:port / URI)</span>
            <input
              type="text"
          ...
          <p className="font-mono text-[0.6rem] leading-relaxed text-slate-600">
