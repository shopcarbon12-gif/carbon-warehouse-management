...
import { listReplenishmentLogs } from "@/lib/queries/inventory-reports";
...
export async function GET(req: Request) {
  ...
  try {
    const rows = await listReplenishmentLogs(pool, session.tid, {
      search,
    ...
    console.error("[reports/replenishment-logs]", e);
