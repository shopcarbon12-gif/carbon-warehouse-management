    ...
    <div className="space-y-4">
      <div className="border-b border-[var(--wms-border)] pb-3">
        ...
        <p className="mt-1 font-mono text-xs text-[var(--wms-muted)]">
          Scan a tag on .15 → encode it to a SKU → re-read to confirm the chip took the write → print the
          matching non-RFID label. One tag at a time, with the .15 proximity slider.
        </p>
      </div>
